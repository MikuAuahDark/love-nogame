...
local function draw_star(s)
	...
	love.graphics.setColor(255*s.scale*MUL, 255*s.scale*MUL, 255*MUL, 255*s.scale*MUL)
	love.graphics.setColor(255*s.scale*MUL, 255*s.scale*MUL, 255*MUL, 255*s.scale*MUL)
...
local function load_image_b64(b64, filename)
	local file_data = base64FileData(b64, filename)
...
function love.load()
	...
	love.graphics.setBackgroundColor(18*MUL, 18*MUL, 18*MUL)
