...
local MUL = love._version >= "11.0" and 1 or 1/255
...
local function getDPI()
	...
	elseif love._version >= "0.9.1" then
...
-- cloud_1.png
R.bg[1].cloud_1_png = base64FileData("\
...
")
-- cloud_1@2x.png
R.bg[2].cloud_1_png = base64FileData("\
...
")
-- cloud_2.png
R.bg[1].cloud_2_png = base64FileData("\
...
")
-- cloud_2@2x.png
R.bg[2].cloud_2_png = base64FileData("\
...
")
-- cloud_3.png
R.bg[1].cloud_3_png = base64FileData("\
...
")
-- cloud_3@2x.png
R.bg[2].cloud_3_png = base64FileData("\
...
")
-- cloud_4.png
R.bg[1].cloud_4_png = base64FileData("\
...
")
-- cloud_4@2x.png
R.bg[2].cloud_4_png = base64FileData("\
...
-- a.png
R.chain[1].a_png = base64FileData("\
...
")
-- a@2x.png
R.chain[2].a_png = base64FileData("\
...
")
-- e.png
R.chain[1].e_png = base64FileData("\
...
")
-- e@2x.png
R.chain[2].e_png = base64FileData("\
...
")
-- g.png
R.chain[1].g_png = base64FileData("\
...
")
-- g@2x.png
R.chain[2].g_png = base64FileData("\
...
")
-- m.png
R.chain[1].m_png = base64FileData("\
...
")
-- m@2x.png
R.chain[2].m_png = base64FileData("\
...
")
-- n.png
R.chain[1].n_png = base64FileData("\
...
")
-- n@2x.png
R.chain[2].n_png = base64FileData("\
...
")
-- o.png
R.chain[1].o_png = base64FileData("\
...
")
-- o@2x.png
R.chain[2].o_png = base64FileData("\
...
")
-- square.png
R.chain[1].square_png = base64FileData("\
...
")
-- square@2x.png
R.chain[2].square_png = base64FileData("\
...
-- blink.png
R.duckloon[1].blink_png = base64FileData("\
...
")
-- blink@2x.png
R.duckloon[2].blink_png = base64FileData("\
...
")
-- normal.png
R.duckloon[1].normal_png = base64FileData("\
...
")
-- normal@2x.png
R.duckloon[2].normal_png = base64FileData("\
iVBORw0KGgoAAAANSUhEUgAAASIAAAGaCAYAAACrJ06uAAAgAElEQVR4nOy9ebgtx1XY+6\
...
function Duckloon:draw()
	...
	love.graphics.setColor(1/MUL, 1/MUL, 1/MUL)
	...
	if DEBUG then
		love.graphics.setColor(0.8/MUL, 0.3/MUL, 0.1/MUL)
		love.graphics.polygon("fill", self.body:getWorldPoints(self.shape:getPoints()))

		love.graphics.setColor(0/MUL, 1/MUL, 0/MUL)
...
function Chain:draw()
	...
	love.graphics.setColor(1/MUL, 1/MUL, 1/MUL, 0.7/MUL)
	...
	if DEBUG then
		for i, link in ipairs(self.links) do
			love.graphics.setColor(1/MUL, 0, 1/MUL)
...
function CloudTrack:draw()
	...
	love.graphics.setColor(1/MUL, 1/MUL, 1/MUL, 0.3/MUL)
...
function love.load()
	...
	love.graphics.setBackgroundColor(43/255/MUL, 165/255/MUL, 223/255/MUL)
	love.physics.setMeter(64)

	local dpiscale = getDPI() > 1 and 2 or 1
	local settings
	if love._version >= "11.0" then
...
function love.draw()
	...
	if DEBUG then
		love.graphics.setColor(0, 0, 0, 0.5/MUL)
