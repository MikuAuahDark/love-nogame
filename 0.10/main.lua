...
function Mosaic:draw()
	self.batch:clear()
	love.graphics.setColor(255*MUL, 255*MUL, 255*MUL, 64*MUL)
	for idx,piece in ipairs(self.pieces) do
		...
		self.batch:setColor(r*MUL, g*MUL, b*MUL)
...
function love.load()
	...
	love.graphics.setBackgroundColor(136*MUL, 193*MUL, 206*MUL)

	local function load_image(file, name)
		return love.graphics.newImage(base64FileData(file))
	end
